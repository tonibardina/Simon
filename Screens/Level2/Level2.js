...
class Level2 extends Component {
  ...
  getLevels = () => {
    if (this.state.lvl === 1) { return <L1 userLevel={this.props.userLevel} setSequence={this.setSequence} game={this.state.game} changeLevel={this.changeLevel} level={this.state.lvl} modalVisible={this.state.modalVisible} startSequence={this.startSequence} clicked={this.state.clicked} cubeGenerator={this.cubeGenerator} errorWindow={this.errorWindow} playing={this.state.playing} /> }
    ...
    if (this.state.lvl === 3) { return <L3 setSequence={this.setSequence} game={this.state.game} changeLevel={this.changeLevel} level={this.state.lvl} modalVisible={this.state.modalVisible} startSequence={this.startSequence} clicked={this.state.clicked} cubeGenerator={this.cubeGenerator} errorWindow={this.errorWindow} game={this.state.game} playing={this.state.playing} gameCompleted={this.gameCompleted}  userResponse={this.userResponse} /> }
    ...
    if (this.state.lvl === 5) { return <L5 setSequence={this.setSequence} game={this.state.game} changeLevel={this.changeLevel} level={this.state.lvl} modalVisible={this.state.modalVisible} startSequence={this.startSequence} clicked={this.state.clicked} cubeGenerator={this.cubeGenerator} errorWindow={this.errorWindow} game={this.state.game} playing={this.state.playing} gameCompleted={this.gameCompleted}  userResponse={this.userResponse} /> }
  }
